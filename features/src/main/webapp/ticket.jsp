                                            ...
                                            <div class="mb-3">
                                                <div class="col-lg-12">
                                                    <select class="form-select" aria-label="Default select example">
                                                        ...
                                                        %>
                                                        <option value="<%= billet.getBilletType() %>"><%= billet.getBilletType() %></option>
                                                        <%
                                                                }
                                                            }else{%>
