                    ...
                    <div class="card">
                        ...
                        <div class="profile-infos d-flex align-items-end flex-sm-row text-sm-start text-center">
                                ...
                                <div class="d-flex align-items-md-end align-items-sm-start align-items-center justify-content-md-between justify-content-start mx-5 flex-md-row flex-column gap-4">
                                    <div class="user-profile-info">
                                        ...
                                        <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-2">
                                            ...
                                            <li class="list-inline-item me-5 fs-6"><i class=" ri-at-line me-2"></i>anass@gmail.com</li>
                            ...
                            <div class="flex-grow-1 mt-3 mt-sm-5 ms-5">
                                <div class="d-flex">
                                    <button class="btn btn-warning btn-sm fw-bold text-white fs-6 me-3 ms-5" type="submit">
                                        Changer mot de passe
                                    </button>
                                    <button class="btn btn-warning btn-sm fw-bold text-white fs-6" type="submit">
                                        Modifier Données
                                    </button>
                                </div>
                            </div>
